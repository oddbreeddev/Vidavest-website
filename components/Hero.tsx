      ...
      <div className="max-w-[1400px] mx-auto w-full px-6 md:px-12 grid lg:grid-cols-12 gap-16 items-center relative z-10">
        <div className="lg:col-span-7 animate-page-enter">
          <div className="inline-flex items-center gap-3 py-2 px-4 rounded-full border border-white/5 bg-white/5 backdrop-blur-md mb-8">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-gold">Global Innovation Hub • 2026</span>
          </div>

          <h1 className="text-5xl md:text-8xl xl:text-9xl font-black leading-[0.85] mb-8 tracking-tighter">
            Fueling <br /> the <span className="brand-gradient-text">Ambition</span> <br /> of Global Youth.
          </h1>

          <p className="text-lg md:text-xl text-gray-400 max-w-xl leading-relaxed mb-10 font-medium">
            Building the financial infrastructure for the next generation of skilled entrepreneurs and visionary leaders across borders.
          </p>
            ...
            <div className="flex -space-x-3">
              {[1, 2, 3].map(i => (
                <div key={i} className="w-12 h-12 rounded-full border-2 border-bgDark bg-[#1A1A24] overflow-hidden">
                   <img src={`https://i.pravatar.cc/100?img=${i+12}`} alt="User" className="w-full h-full object-cover grayscale" />
                </div>
              ))}
            </div>
            <div>
              <p className="text-lg font-black text-white leading-none">1,200+</p>
              <p className="text-[9px] font-bold text-gray-500 uppercase tracking-widest mt-1">Global Founders</p>
            </div>
          </div>
        </div>
          ...
          <div className="relative group">
            ...
            <div className="absolute -top-6 -right-6 glass-card p-5 rounded-2xl animate-float z-20">
               <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[7px] font-black text-gray-500 uppercase tracking-widest">Vision</p>
                    <p className="text-xs font-black text-white">Scale Reached</p>
                  </div>
               </div>
            </div>
          </div>
