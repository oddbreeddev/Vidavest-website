...
class ErrorBoundary extends React.Component<Props, State> {
  // Use property initializer for state to ensure it's properly recognized by the TypeScript compiler on the class instance.
  public state: State = {
    hasError: false
  };
  ...
  public render(): ReactNode {
    ...
    // Explicitly inheriting from React.Component ensures 'state' and 'props' are correctly typed and registered.
