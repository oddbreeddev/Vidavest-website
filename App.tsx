        ...
        return (
          <div className="animate-page-enter">
            ...
            <section className="py-32 bg-[#08080A] border-y border-white/5 overflow-hidden">
               <div className="max-w-7xl mx-auto px-6">
                  <div className="text-center mb-20">
                    ...
                    <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tighter">Our Global <span className="brand-gradient-text">Pillars.</span></h3>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                     {[
                       { title: 'Global Investment', desc: 'Structured equity and debt options for viable youth startups.', icon: '💰' },
                       { title: 'International Education', desc: 'Financial and business intelligence curriculum for a global market.', icon: '📚' },
                       { title: 'Wealth Building', desc: 'Data-driven generational growth programs for emerging leaders.', icon: '📈' },
                       { title: 'Impact Community', icon: '🤝', desc: 'A high-impact ecosystem of global mentorship and networking.' }
                     ].map(pillar => (
            ...
            <div className="py-20 flex justify-center">
               ...
               >
                 <span className="text-gray-600 group-hover:text-gold font-black uppercase tracking-[0.6em] text-[10px] transition-colors duration-300">Discover More About Our Global Vision</span>
